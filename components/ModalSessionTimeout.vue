<template>
  ...
  <b-modal v-model="mostrarModal" no-close-on-backdrop title="Sesión expirada" header-bg-variant="secondary" title-class="text-center text-light" hide-footer centered>
