      ...
      <div class="mx-auto">
        <div class="mt-3" v-if="page === 0">
          ...
          <b-card class="section-card col-md-6 mx-auto">
            ...
            <b-form class="col ml-auto">
              <div class="row mb-1" style="font-size: 1.3rem;">
                <p class="mr-2">CUIT del titular del comercio </p>
                <b-form-input :disabled="enterKeyPressed" @keydown.enter.native="onNextPage" v-model="cuit" type="number" size="lg" class="col-md-6 col-sm-10 ml-1" placeholder="CUIT" no-wheel></b-form-input>
              </div>
              <div class="row" style="font-size: 1.3rem;">
                <p class="mr-2">N° de legajo comercial </p>
                <b-form-input :disabled="enterKeyPressed" @keydown.enter.native="onNextPage" v-model="nroLegajo" type="number" size="lg" class="col-md-6 col-sm-10 ml-1" placeholder="CUIT" no-wheel></b-form-input>
              </div>
            </b-form>
