<template>
  <div class="page main-background">
    ...
    <LoadingOverlay :show="loading || enviando" :message="mensajeEspera" />

    <b-container class="py-4">
      <b-alert v-if="loadError" :model-value="true" variant="danger">
...
definePageMeta({
  ...
  permissions: ['cementerio.read', 'cementerio.update', 'cementerio.admin'],
})
</script>
...
export default {
  ...
  computed: {
    ...
    todosLosPeriodos() {
      return useCementerioStore().periodos || []
    },
    funerarias() {
  ...
  methods: {
    ...
    async confirmarPeriodo() {
      ...
      try {
        ...
        await useCementerioStore().confirmarPeriodo({
