            ...
            <transition name="expand">
              <div v-show="isCardExpanded(0)">
                <div class="li-row first-li">
                  <div class="li-icon"><b-icon-check-lg font-scale="0.75" class="icon-orange"></b-icon-check-lg></div><div class="li-content"> El formulario de reclamo por <b>Pago doble</b> implica solicitar la acreditación del saldo excedente para ser utilizado en futuros pagos u otras tasas impagas.</div>
                </div>
