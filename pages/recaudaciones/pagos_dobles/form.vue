  ...
  <b-card no-body class="col-8 mt-1 section-card" style="margin: 0px auto">
    <fieldset >
      ...
      <b-form-group>
        ...
        @update:model-value="clearFormFieldState('comprobantePago')"></b-form-file>
      ...
      <b-form-group>
        ...
        @update:model-value="clearFormFieldState('comprobantePago2')"></b-form-file>
      ...
      <div v-if="solicitante.esTitular !== 'true'">
        ...
        <b-form-group >
          ...
          @update:model-value="clearFormFieldState('acreditacionTitularidad')"></b-form-file>
