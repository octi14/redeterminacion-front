<template>
  <div class="page main-background">
        ...
        <b-col>
          ...
          <!-- <b-card id="normas" class="section-card shadow-card my-2">
            ...
            <transition name="expand">
              <div>
                <p class="first-li">
                  El trámite de devolución de tributo por doble pago se encuentra regido por el Decreto 3064/2023.
    ...
    <!-- Popups -->
    <BModal id="modalPagosDoblesApoderado" v-model="showPopupA" :no-footer="true" :header-bg-variant="'success'" centered>
        <template #header>
    ...
    <BModal id="modalPagosDoblesPlano" v-model="showPopupB" title="" :no-footer="true" :header-bg-variant="'success'" centered>
        <template #header>
          <div class="modal-info">
            <h5>
                <i class="bi bi-question-circle text-light"></i>
    ...
    <BModal id="modalPagosDoblesConfirmacion" v-model="showConfirmationPopup" no-footer :header-bg-variant="'success'" centered>
        <template #header>
