<template>
  <div class="page main-background">
    ...
    <b-pagination v-if="!loading" v-model="currentPage" class="internal-use-pagination internal-use-wide mt-4" :total-rows="filteredItems.length" :per-page="perPage" align="center" @update:model-value="onPageChange" />
