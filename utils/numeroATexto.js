export function numeroATexto(num) {
  ...
  if (num < 1000) return centenas[Math.floor(num / 100)] + (num % 100 !== 0 ? " " + numeroATexto(num % 100) : "");
